...
class SimpleMessage final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto3.SimpleMessage) */ {
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:proto3.SimpleMessage)
 private:
  class _Internal;
...
inline const std::string& SimpleMessage::text() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:proto3.SimpleMessage.text)
...
inline PROTOBUF_ALWAYS_INLINE void SimpleMessage::set_text(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:proto3.SimpleMessage.text)
}
inline std::string* SimpleMessage::mutable_text() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_text();
  // @@protoc_insertion_point(field_mutable:proto3.SimpleMessage.text)
  return _s;
}
...
inline std::string* SimpleMessage::release_text() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:proto3.SimpleMessage.text)
...
inline void SimpleMessage::set_allocated_text(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:proto3.SimpleMessage.text)
}
...
inline const std::string& SimpleMessage::sender_name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:proto3.SimpleMessage.sender_name)
...
inline PROTOBUF_ALWAYS_INLINE void SimpleMessage::set_sender_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:proto3.SimpleMessage.sender_name)
}
inline std::string* SimpleMessage::mutable_sender_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ...
  // @@protoc_insertion_point(field_mutable:proto3.SimpleMessage.sender_name)
  return _s;
}
...
inline std::string* SimpleMessage::release_sender_name() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:proto3.SimpleMessage.sender_name)
...
inline void SimpleMessage::set_allocated_sender_name(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:proto3.SimpleMessage.sender_name)
}
