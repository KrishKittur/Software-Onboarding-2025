...
const ::uint32_t TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::proto3::SimpleMessage, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::proto3::SimpleMessage, _impl_.text_),
    PROTOBUF_FIELD_OFFSET(::proto3::SimpleMessage, _impl_.sender_name_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::proto3::SimpleMessage)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::proto3::_SimpleMessage_default_instance_._instance,
};
const char descriptor_table_protodef_message_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\rmessage.proto\022\006proto3\"2\n\rSimpleMessage"
    "\022\014\n\004text\030\001 \001(\t\022\023\n\013sender_name\030\002 \001(\tb\006pro"
    "to3"
};
...
SimpleMessage::SimpleMessage(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:proto3.SimpleMessage)
}
...
SimpleMessage::SimpleMessage(
  ...
  // @@protoc_insertion_point(copy_constructor:proto3.SimpleMessage)
}
inline PROTOBUF_NDEBUG_INLINE SimpleMessage::Impl_::Impl_(
...
SimpleMessage::~SimpleMessage() {
  // @@protoc_insertion_point(destructor:proto3.SimpleMessage)
...
// @@protoc_insertion_point(message_clear_start:proto3.SimpleMessage)
...
const ::_pbi::TcParseTable<1, 2, 0, 44, 2> SimpleMessage::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::FastUS1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(SimpleMessage, _impl_.sender_name_)}},
    // string text = 1;
    {::_pbi::TcParser::FastUS1,
...
::uint8_t* SimpleMessage::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:proto3.SimpleMessage)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (!this->_internal_text().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "proto3.SimpleMessage.text");
  ...
  if (!this->_internal_sender_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "proto3.SimpleMessage.sender_name");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:proto3.SimpleMessage)
  return target;
}

::size_t SimpleMessage::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:proto3.SimpleMessage)
  ::size_t total_size = 0;
...
void SimpleMessage::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:proto3.SimpleMessage)
...
// @@protoc_insertion_point(class_specific_copy_from_start:proto3.SimpleMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
